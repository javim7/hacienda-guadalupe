// src/features/cattle/Introduction.jsx
import Image from 'next/image'
import { useTranslations } from 'next-intl'

export default function Introduction() {
  const t = useTranslations('cattle.introduction')
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 md:min-h-[78vh]">
        ...
        <div className="order-2 md:order-2">
          <div className="w-full h-56 sm:h-72 md:h-full relative overflow-hidden bg-gray-200">
            <Image
              src="https://media.hacienda-guadalupe.com/images/Ganado/vacaMainLarge.jpeg"
              alt={t('imageAlt')}
              fill
